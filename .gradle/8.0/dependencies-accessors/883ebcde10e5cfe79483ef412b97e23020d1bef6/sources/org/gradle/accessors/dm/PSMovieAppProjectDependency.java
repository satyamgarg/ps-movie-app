...
@NonNullApi
public class PSMovieAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public PSMovieAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
